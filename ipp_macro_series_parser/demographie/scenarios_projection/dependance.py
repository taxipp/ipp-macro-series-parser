...
def build_prevalence_2010(input_dir = None, 
    ...
    columns_to_delete = [column for column in data.columns if column.startswith('Unnamed') or column.startswith('Ensemble')]
...
def build_prevalence_all_years(globals_node = None,
                              output_dir = None,
                              input_dir = None, 
                              to_csv = None,
                              drees_filename = 'dss43_horizon_2060.xls'
    ...
    if globals_node:
        ...
        csv_file_path = os.path.join(
                output_dir,
                'dependance_prevalence_all_years.csv'
                )
