...
def main():
    ...
    for name,dir in output_dirs_by_file.iteritems():
        assert dir != 'None', \
    ...
    urls_by_file = {
        'insee_projections': 'https://www.insee.fr/fr/statistiques/fichier/2517722/projpop0760_FECcentESPcentMIGcent.xls',
        'drees_dependance' : 'http://drees.solidarites-sante.gouv.fr/IMG/xls/dss43_horizon_2060.xls'
        }
